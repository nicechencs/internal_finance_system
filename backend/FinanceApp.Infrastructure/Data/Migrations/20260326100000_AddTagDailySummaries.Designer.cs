...
namespace FinanceApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260326100000_AddTagDailySummaries")]
    partial class AddTagDailySummaries
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Payable", b =>
                {
                    ...
                    b.ToTable("payables", (string)null, t =>
                        {
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Receivable", b =>
                {
                    ...
                    b.ToTable("receivables", (string)null, t =>
                        {
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Tag", b =>
                {
                    ...
                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("idx_tags_created_by")
                        .HasFilter("is_deleted = false");
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.TagBinding", b =>
                {
                    ...
                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("idx_tag_bindings_created_by")
                        .HasFilter("is_deleted = false");
