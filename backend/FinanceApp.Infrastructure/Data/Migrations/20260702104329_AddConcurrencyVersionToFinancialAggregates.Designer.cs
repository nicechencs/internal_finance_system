...
namespace FinanceApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260702104329_AddConcurrencyVersionToFinancialAggregates")]
    partial class AddConcurrencyVersionToFinancialAggregates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.ClassificationRule", b =>
                {
                    ...
                    b.Property<string>("MatchValueMax")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.FixedDepositRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("WithdrawalTransactionId")
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("fixed_deposit_records", (string)null);
                });
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Payable", b =>
                {
                    ...
                    b.ToTable("payables", null, t =>
                        {
                            t.HasCheckConstraint("CK_payables_exactly_one_counterparty", "(CASE WHEN supplier_id IS NOT NULL THEN 1 ELSE 0 END + CASE WHEN customer_id IS NOT NULL THEN 1 ELSE 0 END + CASE WHEN person_id IS NOT NULL THEN 1 ELSE 0 END) = 1");
                        });
                });
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.PayableDetail", b =>
                {
                    ...
                    b.HasIndex("PayableId", "TransactionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.PayableType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("payable_types", (string)null);
                });
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Receivable", b =>
                {
                    ...
                    b.Property<long?>("ReceivableTypeId")
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("receivables", null, t =>
                        {
                            t.HasCheckConstraint("CK_receivables_exactly_one_counterparty", "(CASE WHEN customer_id IS NOT NULL THEN 1 ELSE 0 END + CASE WHEN supplier_id IS NOT NULL THEN 1 ELSE 0 END + CASE WHEN person_id IS NOT NULL THEN 1 ELSE 0 END) = 1");
                        });
                });
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.ReceivableDetail", b =>
                {
                    ...
                    b.HasIndex("ReceivableId", "TransactionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.ReceivableType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("receivable_types", (string)null);
                });
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.TagBinding", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("OwnerType", "OwnerId", "TagId")
                        .IsUnique()
                        .HasDatabaseName("ux_tag_bindings_owner_tag")
                        .HasFilter("is_deleted = false");

                    b.HasIndex("TagId", "OwnerType", "OwnerId")
                        .HasDatabaseName("idx_tag_bindings_tag")
                        .HasFilter("is_deleted = false");

                    b.ToTable("tag_bindings", (string)null);
                });

            modelBuilder.Entity("FinanceApp.Domain.Entities.TagDailySummary", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("SummaryDate", "TagId", "MetricScope")
                        .IsUnique()
                        .HasDatabaseName("ux_tag_daily_summaries_date_tag_scope")
                        .HasFilter("is_deleted = false");

                    b.HasIndex("TagId", "MetricScope", "SummaryDate")
                        .HasDatabaseName("idx_tag_daily_summaries_tag_scope_date")
                        .HasFilter("is_deleted = false");

                    b.ToTable("tag_daily_summaries", (string)null);
                });

            modelBuilder.Entity("FinanceApp.Domain.Entities.TagRule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.TagRuleTag", b =>
                {
                    b.Property<long>("TagRuleId")
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("TagRuleId", "TagId");

                    b.HasIndex("TagId");

                    b.ToTable("tag_rule_tags", (string)null);
                });
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Payable", b =>
                {
                    ...
                    b.HasOne("FinanceApp.Domain.Entities.PayableType", "PayableType")
                        .WithMany("Payables")
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Receivable", b =>
                {
                    ...
                    b.HasOne("FinanceApp.Domain.Entities.ReceivableType", "ReceivableType")
                        .WithMany("Receivables")
                        .HasForeignKey("ReceivableTypeId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.TagRuleTag", b =>
                {
                    ...
                    b.HasOne("FinanceApp.Domain.Entities.TagRule", "TagRule")
                        .WithMany("TagRuleTags")
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Account", b =>
                {
                    b.Navigation("FixedDepositRecords");
                });
